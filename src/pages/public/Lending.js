...
const Lending = () => {
    ...
    const profileBorrower = useSelector(
        (state) => state.borrower?.profile?.name,
    );
                ...
                <div className="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
                    <div className="mr-auto place-self-center lg:col-span-7">
                        <h1 className="max-w-2xl mb-4 text-4xl font-extrabold leading-none tracking-tight md:text-5xl xl:text-6xl ">
                            Wujudkan Pribadi Finansial Islami bersama Amanah P2P
                            Syariah
                            {/* products &amp; brands. */}
                        </h1>
                        <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl ">
                            Pinjaman Dana Syariah tanpa Riba, Mudah, Aman, dan
                            Tanpa Jaminan dengan Sistem Pendanaan P2P Syariah.
                            Lender dan Borrower dapat bertransaksi dengan aman
                            dan nyaman.{' '}
                            {/* <a
                                free
                                and
                ...
                <div className="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
                    ...
                    <div className="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                        <div className="text-gray-500 sm:text-lg dark:text-gray-400">
                            ...
                            <p className="mb-8 font-light lg:text-xl">
                                Amanah P2P Lending Syariah menawarkan solusi
                                berbasis website untuk memudahkan anda dalam
                                bertransaksi. Dengan menggunakan website, anda
                                dapat mengakses Amanah P2P Lending Syariah
                            ...
                            <ul className="pt-8 space-y-5 border-t border-gray-200 my-7 dark:border-gray-700">
                                <li className="flex space-x-3">
                                    ...
                                    <span className="text-base font-medium leading-tight text-gray-900 dark:text-white">
                                        Lakukan peminjaman dengan mudah
                                        dimanapun dan kapanpun
                                    </span>
                                </li>
                                <li className="flex space-x-3">
                                    ...
                                    <span className="text-base font-medium leading-tight text-gray-900 dark:text-white">
                                        Melakukan pendanaan pada berbagai macam
                                ...
                                <li className="flex space-x-3">
                                    ...
                                    <span className="text-base font-medium leading-tight text-gray-900 dark:text-white">
                                        Melakukan credit score dengan teknologi
                                        AI
                                    </span>
                                </li>
                            </ul>
                    ...
                    <div className="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                        ...
                        <div className="text-gray-500 sm:text-lg dark:text-gray-400">
                            ...
                            <p className="mb-8 font-light lg:text-xl">
                                Aplikasi Amanah sudah support pada android untuk
                                memudahkan anda dalam bertransaksi. Dengan
                                menggunakan aplikasi, anda dapat mengakses
                                Amanah P2P Lending Syariah dimanapun dan
                                kapanpun.
                            </p>
                            {/* List */}
                            <ul className="pt-8 space-y-5 border-t border-gray-200 my-7 dark:border-gray-700">
                ...
                <div className="items-center max-w-screen-xl px-4 py-8 mx-auto lg:grid lg:grid-cols-4 lg:gap-16 xl:gap-24 lg:py-24 lg:px-6">
                    <div className="col-span-2 mb-8">
                        ...
                        <h2 className="mt-3 mb-4 text-3xl font-extrabold tracking-tight text-gray-900 md:text-3xl dark:text-white">
                            Di support oleh teknologi Artificial Intelligence
                            Credit Scoring
                        </h2>
                        <p className="font-light text-gray-500 sm:text-xl dark:text-gray-400">
                            Amanah P2P Lending Syariah menggunakan teknologi AI
                            untuk menentukan credit score pinjaman anda
                        </p>
                    ...
                    <figure className="max-w-screen-md mx-auto">
                        ...
                        <blockquote>
                            <p className="text-xl font-medium text-gray-900 md:text-2xl dark:text-white">
                                "Advantages of helping people include you being
                                a good example for your children, family, and
                                friends, and you having a direct impact on the
                                trajectory of the lives of a lot of people."
                            </p>
                        </blockquote>
                    ...
                    <div className="space-y-4">
                        ...
                        >
                            ...
                            <p className="mt-4 px-4 leading-relaxed text-white">
                                Amanah P2P Lending Syariah adalah platform yang
                                mempertemukan antara peminjam dan pendana dengan
                                menggunakan teknologi AI Credit Scoring.
                            </p>
                        </details>
                        <details className="group [&_summary::-webkit-details-marker]:hidden">
                            ...
                            <p className="mt-4 px-4 leading-relaxed text-white">
                                Dalam P2P Lending, Lender merupakan pihak yang
                                memberikan pinjaman kepada peminjam. Lender akan
                                mendapatkan keuntungan dari keuntungan pinjaman
                                yang diberikan kepada peminjam.
                            </p>
                        </details>
                        <details className="group [&_summary::-webkit-details-marker]:hidden">
                            <summary className="flex cursor-pointer items-center justify-between gap-1.5 rounded-lg bg-gray-50 p-4 text-gray-900">
                            ...
                            <p className="mt-4 px-4 leading-relaxed text-white">
                                Dalam P2P Lending, Borrower merupakan pihak yang
                                meminjam uang kepada Lender. Borrower akan
                                membayar kembali pinjaman beserta keuntungan
                        ...
                        <details className="group [&_summary::-webkit-details-marker]:hidden">
                            ...
                            <p className="mt-4 px-4 leading-relaxed text-white">
                                Dalam aplikasi Amanah P2P Lending Syariah, Fitur
                                Autolend merupakan fitur yang dapat digunakan
                                oleh Lender untuk melakukan pendanaan secara
                                otomatis. Dengan menggunakan fitur ini, Lender
                        ...
                        <details className="group [&_summary::-webkit-details-marker]:hidden">
                            <summary className="flex cursor-pointer items-center justify-between gap-1.5 rounded-lg bg-gray-50 p-4 text-gray-900">
                                <h2 className="font-medium">
                                    Akad apa yang digunakan dalam Amanah P2P
                                    Lending Syariah?
                                </h2>
                                <svg
                                    className="h-5 w-5 shrink-0 transition duration-300 group-open:-rotate-180"
                            ...
                            <p className="mt-4 px-4 leading-relaxed text-white">
                                Akad yang digunakan oleh Amanah P2P Lending
                                Syariah yaitu akad Jual Beli. Akad Jual Beli
                                merupakan akad yang digunakan dalam transaksi
                                jual beli barang atau jasa. Dalam akad ini,
                                pihak yang menjual barang atau jasa disebut
                                sebagai penjual (muqridh) dan pihak yang membeli
                                barang atau jasa disebut sebagai pembeli
                                (musta’min).
                            </p>
                        </details>
                        <details className="group [&_summary::-webkit-details-marker]:hidden">
                            <summary className="flex cursor-pointer items-center justify-between gap-1.5 rounded-lg bg-gray-50 p-4 text-gray-900">
                                <h2 className="font-medium">
                                    Platform apa saja yang dapat digunakan untuk
                                    mengakses Amanah P2P Lending Syariah?
                                </h2>
                                <svg
                                    className="h-5 w-5 shrink-0 transition duration-300 group-open:-rotate-180"
                                    xmlns="http://www.w3.org/2000/svg"
                            ...
                            <p className="mt-4 px-4 leading-relaxed text-white">
                                Amanah P2P Lending Syariah dapat diakses melalui
