        ...
        <div className="h-32 rounded-lg bg-white lg:col-span-2 ">
          <div>
            <div className="flex flex-col">
              <div className="border-b shadow-md border-b-gray-200 p-5 flex items-center gap-3">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
            ...
            <div className="relative max-h-[460px] !overflow-y-auto rounded-b-md p-4 bg-white shadow-md">
