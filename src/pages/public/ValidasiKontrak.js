                ...
                <div class="container flex items-center min-h-screen px-6 py-12 mx-auto">
                    <div class="flex flex-col items-center max-w-sm mx-auto text-center">
                        ...
                        <p class="mt-4 text-gray-500 dark:text-gray-400">
                            The contract you are looking for doesn't exist. Here
                ...
                <div className="sm:p-8 md:p-12 lg:p-28 xl:p-44 max-w-7xl sm:pt-12 md:pt-12 lg:pt-12 xl:pt-12">
                    <div className="px-4 sm:px-0 ">
                        <h3 className="text-base font-semibold leading-7 text-gray-500">
                            Kontrak digital ini dapat dijadikan sebagai bukti
                            yang sah pada kontrak peminjaman yang telah
                            disepakati oleh pihak peminjam dan pihak pemberi
                            pinjaman. Kontrak ini berlaku efektif setelah pihak
                            pendanaan telah melakukan pendanaan. Kontrak ini
                            dibuat secara otomatis oleh sistem dan tidak
